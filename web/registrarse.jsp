        ...
        <div class="containerInicioSesion">
            ...
            <div class="juntar">
                <div class="divUsuarioGrande1">
                    ...
                    <div class="divUsuario">
                        <input type="password" id="password" class="inputContrasena" placeholder="Contraseña">
                    </div>
            ...
            <div class="divErrorUsuario" id="divErrorContrasena" style="display:none">Contrasena Inválida</div>
            <div class="juntar">
                <div class="divUsuarioGrande1">
                    <div class="interior">
                        <i class='bx bx-lock'></i></div>
                    <div class="divUsuario">
                        <input type="password" id="passwordVerificar" class="inputContrasena" placeholder="Confirmar Contraseña">
                    </div>
                ...
                <div class="divErrorUsuario" id="divErrorContrasena1" style="display:none">Contraseña Incorrecta</div>
