...
<i class='bx bxs-up-arrow' ></i>                   
        ...
        <img src="imgArrayItems/sport.png" id="foto1" class="imagen" height="1200px" width="960px">
        
    </div>
        <img src="imgArrayItems/as.png" id="foto2" class="imagen" height="1200px" width="960px">
